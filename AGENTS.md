...
- Use `main` as the base branch for task worktrees.
...
- Before the first normal repository write, run `sh .codex/skills/using-git-worktrees/scripts/worktree-context.sh`, then create the isolated checkout with `sh .codex/skills/using-git-worktrees/scripts/worktree-add.sh <branch-name>`.
